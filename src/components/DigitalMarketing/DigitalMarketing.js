...
export default function DigitalMarketing() {
  return (
    <section>
      <div className="app__container relative isolate overflow-hidden bg-white px-6 py-20 sm:py-20 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 pl-10 sm:p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1">
            <Image
              className="w-full max-w-none"
              src={image.digitalMarketing1}
              alt=""
            />
          </div>
            ...
            <div className="lg:pr-4">
              <div className="max-w-xl text-base leading-7 lg:max-w-lg">
                <p className="app__text">
                  ...
                  marketing will act as rocket fuel for your race car. At WebDev
                  Pvt. Ltd., with the help of digital marketing, we provide:
                </p>
                <ul
                  role="list"
                  className="mt-8 space-y-4 sm:space-y-8 app__text"
                >
                ...
                <h2 className="mt-8 sm:mt-16 text-2xl font-bold tracking-tight text-gray-900">
