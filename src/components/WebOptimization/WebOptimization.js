...
const WebOptimization = () => {
  return (
    <section className="we-are-area py-4 md:py-20">
      <div className="app__container grid grid-cols-1 md:grid-cols-2 gap-8 relative">
        ...
        <div className="we-are-img order-1 md:order-2">
          <div className="we-are-banner-img">
            <Image src={image.webOpt1} alt="SEM Marketing" />
          </div>
        </div>
      </div>
      <div className="app__container my-auto order-2 md:order-1">
        <div className="we-are-content">
          <p className="app__text">
            ...
            <br />
            <br />
            The internet is taking over the role of &quot;asking a friend&quot;
            in all industries. So, by positioning your business correctly, you
            can consistently win people who had previously never heard of your
            ...
            map so that, when consumers search for relevant terms, your website
            and business will always show up.
            <br />
            <br />
            The foundation of our website optimization process is to identify
            the problems, the issues in one&apos;s website. We use available
            software. tools to search for potential issues with SEO, page speed,
            and mobile usability, and more.
            <br />
            <br />
            ...
            <br />
            We understand which keywords and terms your target customers are
            using. actively searching. This knowledge helps us with everything,
            from planning and writing content for your website, to creating
            landing pages, campaigns, and tracking your results.
            <br />
            <br />
            <strong>OPTIMIZE YOUR WEBSITE CONTENT</strong>
            <br />
            We make sure the content is written, the contents are structured,
            and your Site structure, navigation, external links, and many other
