...
const BottomBar = () => {
  ...
  return (
    <nav
      ref={dropdownRef}
      className="app__bottom-bar w-full bg-white fixed bottom-0 py-4 rounded-tr-xl rounded-tl-xl px-6 z-99 shadow-2xl md:hidden border-[1px] border-t-slate-100"
    >
      <div className="flex justify-between items-center">
        <Link
          ...
          className={`flex items-center justify-center flex-col gap-y-2 transition-all duration-300 ease ${
            activeSegment === null ? "activeMenu" : "text-gray-400"
          }`}
        >
          <HomeIcon
            className={`h-5 w-5 flex-none ${
              activeSegment === null ? "h-6 w-6" : ""
            }`}
            aria-hidden="true"
          />
        ...
        <Link
          ...
          onClick={() => setToggle(false)}
          className={`flex items-center justify-center flex-col gap-y-2 transition-all duration-300 ease ${
            activeSegment === "about" ? "activeMenu" : "text-gray-400"
          }`}
        >
          <UserGroupIcon
            className={`h-5 w-5 flex-none ${
              activeSegment === "about" ? "h-6 w-6" : ""
            }`}
            aria-hidden="true"
          />
        ...
        >
          <Cog6ToothIcon
            className={`h-5 w-5 flex-none  ${
              activeSegment === "services" || toggle
                ? "h-6 w-6 animate-[spin_4s_linear_infinite]"
                : ""
            }`}
            aria-hidden="true"
          />
        ...
        <div
          className={`p-2 absolute w-full z-99 bottom-[4.5rem] left-0 right-0 bg-white rounded-lg drop-shadow-sm grid grid-cols-2 border-[1px] border-t-slate-100 transition-all duration-300 ease-in-out ${
        ...
        <Link
          ...
          onClick={() => setToggle(false)}
          className={`flex items-center justify-center flex-col gap-y-2 transition-all duration-300 ease ${
            activeSegment === "portfolio" ? "activeMenu" : "text-gray-400"
          }`}
        >
          <BriefcaseIcon
            className={`h-5 w-5 flex-none ${
              activeSegment === "portfolio" ? "h-6 w-6" : ""
            }`}
            aria-hidden="true"
          />
        ...
        <Link
          ...
          onClick={() => setToggle(false)}
          className={`flex items-center justify-center flex-col gap-y-2 transition-all duration-300 ease ${
            activeSegment === "contact" ? "activeMenu" : " text-gray-400"
          }`}
        >
          <EnvelopeIcon
            className={`h-5 w-5 flex-none ${
              activeSegment === "contact" ? "h-6 w-6" : ""
            }`}
            aria-hidden="true"
          />
